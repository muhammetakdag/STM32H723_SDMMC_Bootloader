...
uint32_t SDMMC_CmdBlockLength(SDMMC_TypeDef *SDMMCx, uint32_t BlockSize)
{
	...
	errorstate = SDMMC_GetCmdResp1(SDMMCx, SDMMC_CMD_SET_BLOCKLEN,
	SDMMC_CMDTIMEOUT);
...
uint32_t SDMMC_CmdBlockCount(SDMMC_TypeDef *SDMMCx, uint32_t BlockCount)
{
	...
	/* Check for error conditions */
	errorstate = SDMMC_GetCmdResp1(SDMMCx, SDMMC_CMD_SET_BLOCK_COUNT,
	SDMMC_CMDTIMEOUT);
...
uint32_t SDMMC_CmdErase(SDMMC_TypeDef *SDMMCx, uint32_t EraseType)
{
	...
	/* Check for error conditions */
	errorstate = SDMMC_GetCmdResp1(SDMMCx, SDMMC_CMD_ERASE,
...
uint32_t SDMMC_CmdSendStatus(SDMMC_TypeDef *SDMMCx, uint32_t Argument)
{
	...
	/* Check for error conditions */
	errorstate = SDMMC_GetCmdResp1(SDMMCx, SDMMC_CMD_SEND_STATUS,
	SDMMC_CMDTIMEOUT);
...
uint32_t SDMMC_CmdSwitch(SDMMC_TypeDef *SDMMCx, uint32_t Argument)
{
	...
	/* Check for error conditions */
	errorstate = SDMMC_GetCmdResp1(SDMMCx, SDMMC_CMD_HS_SWITCH,
	SDMMC_CMDTIMEOUT);
		...
		uint8_t *pResponse)
{
	...
	/* Check for error conditions */
	errorstate = SDMMC_GetCmdResp5(SDMMCx, SDMMC_CMD_SDMMC_RW_DIRECT,
			pResponse);
...
uint32_t SDMMC_GetCmdResp2(SDMMC_TypeDef *SDMMCx)
{
	...
	do
	{
		...
		sta_reg = SDMMCx->STA;
			...
			& (SDMMC_FLAG_CCRCFAIL | SDMMC_FLAG_CMDREND | SDMMC_FLAG_CTIMEOUT))
			== 0U) || ((sta_reg & SDMMC_FLAG_CMDACT) != 0U));
