...
HAL_StatusTypeDef HAL_MMC_ReadBlocks_DMA(MMC_HandleTypeDef *hmmc,
		uint8_t *pData, uint32_t BlockAdd, uint32_t NumberOfBlocks);
...
HAL_StatusTypeDef HAL_MMC_RPMB_ProgramAuthenticationKey_IT(
		MMC_HandleTypeDef *hmmc, const uint8_t *pKey, uint32_t Timeout);
...
uint32_t HAL_MMC_RPMB_GetWriteCounter_IT(MMC_HandleTypeDef *hmmc,
		uint8_t *pNonce);
HAL_StatusTypeDef HAL_MMC_RPMB_WriteBlocks(MMC_HandleTypeDef *hmmc,
		const uint8_t *pData, uint16_t BlockAdd, uint16_t NumberOfBlocks,
...
HAL_StatusTypeDef HAL_MMC_RPMB_ReadBlocks(MMC_HandleTypeDef *hmmc,
		uint8_t *pData, uint16_t BlockAdd, uint16_t NumberOfBlocks,
		const uint8_t *pNonce, uint8_t *pMAC, uint32_t Timeout);
