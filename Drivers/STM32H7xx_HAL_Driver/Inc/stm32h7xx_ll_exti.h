...
#define LL_EXTI_ReadReg(__REG__) READ_REG(EXTI->__REG__)
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_EXTI_IsEnabledRisingTrig_64_95(
			uint32_t ExtiLine)
	{
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_EXTI_IsEnabledFallingTrig_64_95(
			uint32_t ExtiLine)
	{
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_D3_EXTI_IsEnabledPendMask_32_63(
			uint32_t ExtiLine)
	{
	...
	{
		return (uint32_t) (READ_BIT(EXTI->D3PCR1L,
				((ExtiLine * ExtiLine) * 3UL))
				/ (ExtiLine * ExtiLine));
	}
	...
	{
		return (uint32_t) (READ_BIT(EXTI->D3PCR2L,
				((ExtiLine * ExtiLine) * 3UL))
				/ (ExtiLine * ExtiLine));
	}
