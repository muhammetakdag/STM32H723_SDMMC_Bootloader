...
#define LL_HSEM_ReadReg(__INSTANCE__, __REG__) READ_REG(__INSTANCE__->__REG__)
	 ...
	 */
	__STATIC_INLINE uint32_t LL_HSEM_IsSemaphoreLocked(
			const HSEM_TypeDef *HSEMx, uint32_t Semaphore)
	{
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_HSEM_IsEnabledIT_C1IER(
			const HSEM_TypeDef *HSEMx, uint32_t SemaphoreMask)
	{
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_HSEM_IsActiveFlag_C1MISR(
			const HSEM_TypeDef *HSEMx, uint32_t SemaphoreMask)
	{
