...
void MX_GPIO_Init(void)
{
	...
	HAL_GPIO_WritePin(BOOTLOADER_STATUS_LED_GPIO_Port,
	BOOTLOADER_STATUS_LED_Pin, GPIO_PIN_RESET);
	...
	GPIO_InitStruct.Pin = GPIO_PIN_0 | GPIO_PIN_1 | GPIO_PIN_2 | GPIO_PIN_10
			| GPIO_PIN_11 | GPIO_PIN_12 | GPIO_PIN_13 | GPIO_PIN_14 | GPIO_PIN_4
	...
	GPIO_InitStruct.Pin = BOOTLOADER_STATUS_LED_Pin;
	GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
	GPIO_InitStruct.Pull = GPIO_NOPULL;
	GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
	HAL_GPIO_Init(BOOTLOADER_STATUS_LED_GPIO_Port, &GPIO_InitStruct);
